(function() {
  ...
  WebHandshake8 = (function() {
    function WebHandshake8(req, connection, head, origin, location) {
      ...
      session = transport.Session.bySessionIdOrNew(void 0, this.req.sockjs_server);
  ...
  WebSocket8Receiver = (function() {
    ...
    WebSocket8Receiver.prototype.didMessage = function(bin_data) {
      var buf, i, key, l, length, masking, opcode, payload, payload_str, reason, status;
      if (bin_data) {
      ...
      if (opcode === 1) {
        ...
        this.session.didMessage(JSON.parse(payload_str));
        if (this.recv_buffer) {
